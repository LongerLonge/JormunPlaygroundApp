...
public class LarRangeSeekBar extends View {

    private static final String TAG = "LarRangeSeekBar";
    ...
    private LarRangeSeekBarListener listener;
    ...
    public LarRangeSeekBar(Context context) {
        super(context);
        initDefaults();
     ...
     */
    public LarRangeSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initDefaults();
    ...
    public interface LarRangeSeekBarListener {
        void onCreate(LarRangeSeekBar rangeSeekBar, int index, float value);
        void onSeek(LarRangeSeekBar rangeSeekBar, int index, float value);
        void onSeekStart(LarRangeSeekBar rangeSeekBar, int index, float value);
        void onSeekStop(LarRangeSeekBar rangeSeekBar, int index, float value);
    }

    public void setListener(LarRangeSeekBarListener listener) {
